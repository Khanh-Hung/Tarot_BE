    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("REST API Backend built with Spring Boot 3.3, Java 21, Supabase PostgreSQL, and CQRS Architecture.")
                        .contact(new Contact().name("Oracle AI Engineering Team"))
